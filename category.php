...
<body class="gray-bg">
                        ...
                        <div class="search_wrapper d-flex flex-wrap">
                            ...
                            <div class="search_column d-flex flex-wrap">
                                <div class="search_form mt-15">
                                    <input name="keyword" style="width: 600px; float: right;" type="text" value="Search">
                                </div>
    ...
    <section class="published_area pt-115">
		...
		<?php	
				...
				$counter = mysqli_query($conn, "SELECT COUNT(*) as Count FROM ads where category_id='$category_id'"); 
		...
		?>
            <div class="row">
                <div class="col-lg-6">
                    <div class="section_title pb-15">
                        <h3 class="title"><?php echo "All ads";?></h3>
			...
			<?php 
				...
				$query=mysqli_query($conn,"select * from `ads` where category_id='$category_id'");
